...
[![License](https://img.shields.io/pypi/l/faiss-imputer.svg)](https://github.com/ScionKim/FaissImputer/blob/v0.3.6/LICENSE)
...
Current release: [0.3.6](https://github.com/ScionKim/FaissImputer/releases/tag/v0.3.6).
...
```bash
python -m pip install --upgrade "faiss-imputer>=0.3.6"
```
...
This project is licensed under the [MIT License](https://github.com/ScionKim/FaissImputer/blob/v0.3.6/LICENSE).
